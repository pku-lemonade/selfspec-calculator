...
- [x] 1.1 Add per-component leakage-power fields (mW) to hardware configuration models, covering all modeled components.
...
- [x] 2.1 Add estimator helpers to compute total leakage power and burst leakage energy (`mW * ns = pJ`).
